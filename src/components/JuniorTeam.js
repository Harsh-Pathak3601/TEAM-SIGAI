...
const JuniorTeam = () => {
  ...
  useEffect(() => {
    ...
    const handleCardClick = (e) => {
      // Ignore clicks on LinkedIn links
  ...
  return (
    <section id="junior-team" className="junior-team-section text-white min-h-screen py-16">
      ...
      <div className="container mx-auto px-4">
        ...
        <div id="team-container" ref={teamContainerRef} className="flex flex-wrap justify-center items-center gap-6">
          {teamMembers.map((member, index) => (
            <div 
              key={member.id} 
              className="team-card card-hidden w-[180px] h-[350px] transition-all duration-500 ease-in-out cursor-pointer" 
              data-id={member.id}
            >
